...
## SDP offer generated by the WHEP endpint

If the WHEP player preffers the WHEP Endpoint to generate the SDP offer, the WHEP player will send a POST request without HTTP BODY and an Accept HTTP header of "application/sdp" to the configured WHEP endpoint URL.
